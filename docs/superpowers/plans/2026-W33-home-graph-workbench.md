...
5. Add positions to the graph response.
...
5. Return an error from both routes when the service rejects a move.
6. Run the focused API and knowledge tests until they pass.
...
9. Force the tree on mobile and honor reduced motion.
10. Add English and German text for all new controls and states.
11. Run the focused Home tests until they pass.
